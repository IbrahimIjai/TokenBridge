...
import NetworkSwitch from "./scaffold-eth/NetworkSwitch";
      ...
      <div className="w-auto navbar-start lg:w-1/2">
        ...
        <Link href="/" passHref className="items-center hidden gap-2 ml-4 mr-6 lg:flex shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight">BRIDGE IT</span>
            {/* <span className="text-xs">Ethereum dev stack</span> */}
          </div>
        </Link>
        <ul className="hidden gap-2 px-1 ml-3 lg:flex lg:flex-nowrap menu menu-horizontal">
          <HeaderMenuLinks />
        </ul>
      </div>
